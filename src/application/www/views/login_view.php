...
<body>
    ...
    <div id="container">
        ...
        <header>
            <h1 id="logo">
                <a href="../index.html"><img src="../images/logo1.png" alt="幼児無料プリントサイト　ぷちはぐ"></a>
            </h1>
        </header>
        ...
        <nav id="menubar">
            <ul>
                ...
                <li class="current"><a href="signup.html">会員登録・ログイン</a></li>
        ...
        <div id="contents">
            <section class="box1">
                ...
                <div>
                    <p style="text-align: center;">会員登録がおすみでない方は<a href="signup.html">こちら</a>から</p>
                </div>
                <!--/#contents-->
                    ...
                    <div class="form">
                        ...
                        <div class="mailWrapper">
                            <div class="form-group">
                                ...
                                <label for="mail"><strong>ご登録のメールアドレス</strong></label>
                        ...
                        <!-- バリデーション -->
                        <div class="c">
                            <input type="submit" class="btn" name="btn_submit" value="送信" style="background:#ffbbbb;margin-top: 10px;" >
                        </div>
                    </div>
                ...
                <div>
                    <p style="text-align: center;">パスワードを忘れた方は<a href="pass_reset.html">こちら</a>から</p>
                </div>
            </section>
        </div>
