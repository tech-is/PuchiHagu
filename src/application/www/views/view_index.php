...
<body class="home">
    ...
    <div id="container">
        ...
        <header>
            <h1 id="logo">
                <a href="http://puchihagu.com/index.php/Top"><img src="http://puchihagu.com/topdist/images/logo1.png" alt="SAMPLE COMPANY"></a>
            </h1>
            <!--スライドショー-->
            <aside id="mainimg">
                ...
                <div class="slide0"><img src="http://puchihagu.com/topdist/images/waku.png" alt=""></div>
            </aside>
        </header>
        ...
        <p class="nav-fix-pos-pagetop">
            <a href="#"><img src="http://puchihagu.com/topdist/images/pagetop.png" alt="PAGE TOP"></a>
        </p>
