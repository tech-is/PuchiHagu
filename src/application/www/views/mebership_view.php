    ...
    <div id="container">
        ...
        <nav id="menubar">
            <ul>
                ...
                <li><a href="../signup/signup.html">会員登録・ログイン</a></li>
                <li><a href="../print.html">プリントする</a></li>
                <li><a href="../oshirase.html">お知らせ・コラム</a></li>
                <li class="current"><a href="">このサイトについて・利用規約</a></li>
        ...
        <div id="contents">
            <section class="box1">
                ...
                <div id="contents">
                    ...
                    <p>当社のサービスを無断にて転載・及び営利目的に使用する行為</p>
                    ...
                    <br><br><br>
                    <div>
                        <p style="text-align: center; font-size: large;"><a href="../signup/signup_passset.html">会員登録へ戻る</a></p>
                    </div>
                </div>
