                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>更新日時</th>
                                                <th>累計ダウンロード回数
                                                    <a href="https://blog.siteanatomy.com/2017/09/pdf-pageview-tracking.html">(詳細)</a>
                                                </th>
                                                <th></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>い</td>
                                                <td>い</td>
                                                <td>hiragana-i.pdf</td>
                                                <td>2020-01-01 00:00:00</td>
                                                <th>100</th>
                                                <td>
                                                    <a class="btn btn-outline-primary btn-sm" href="">プレビュー</a>
                                                    <a class="btn btn-outline-primary btn-sm" href="admin_print_edit.html">編集</a>
                                                    <a class="btn btn btn-outline-danger btn-sm" href="admin_print_delete.html">削除</a>
                                                </td>
