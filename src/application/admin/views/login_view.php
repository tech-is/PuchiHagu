        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="input-group mb-3">
                        <input type="email" id="email" name="email" value="<?php if(!empty($post_data["email"])){echo $post_data["email"];} ?><?php $this->load->helper('cookie');if(get_cookie("sessionid2")){echo get_cookie("sessionid2");}?>" class="form-control" placeholder="Email">
                ...
                　　<?php endif; ?>
                    ...
                    <div class="input-group mb-3">
                        <input type="password"id="password"name="password" value="<?php $this->load->helper('cookie'); if(get_cookie ("sessionid1")){echo get_cookie("sessionid1");}?>" class="form-control" placeholder="Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
