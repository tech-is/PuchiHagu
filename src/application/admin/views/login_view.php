            ...
            <div class="card-body login-card-body">
                ...
                <?= form_open('login/index'); ?>
                    <div class="input-group mb-3">
                        <input type="email" id="email" name="email" value="<?php if(!empty($post_data["email"])){echo $post_data["email"];} ?><?php if(!empty($_COOKIE["sessionid1"])){echo $_COOKIE["sessionid1"];}?>" class="form-control" placeholder="Email">
                ...
                　　<?php endif; ?>
                    ...
                    <div class="input-group mb-3">
                        <input type="password"id="password"name="password" value="<?php if(!empty($_COOKIE["sessionid2"])){echo $_COOKIE["sessionid2"];}?>" class="form-control" placeholder="Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
